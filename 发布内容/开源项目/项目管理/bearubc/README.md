# BEARUBC · GitLink 社区镜像组织

> 来源：https://github.com/BEARUBC
...
| 表单项 | 填写内容 |
|--------|---------|
| 组织账号 | `bearubc`（被占用则 `bearubc-mirror`） |
| 组织名称 | `BEARUBC（社区镜像）` |
| 组织描述 | 非官方社区镜像，仅收录 BEARUBC（UBC 团队）公开发布的开源项目；版权归原作者（https://github.com/BEARUBC）；仓库以只读镜像方式同步，每 8 小时更新一次 |
| 所在地区 | 加拿大（不列颠哥伦比亚大学） |
...
|-----------|---------|--------|-----------|
| r-prime | [r-prime.md](r-prime.md) | MIT | ✅ 可镜像 |
