# thc1006 · GitLink 社区镜像组织

> 来源：<https://github.com/thc1006>
...
| 表单项 | 填写内容 |
| :--- | :--- |
| 组织账号 | `thc1006`（被占用则 `thc1006-mirror`） |
| 组织名称 | `thc1006（社区镜像）` |
| 组织描述 | 非官方社区镜像，仅收录 thc1006 公开发布的开源项目；版权归原作者（<https://github.com/thc1006>）；仓库以只读镜像方式同步，每 8 小时更新一次 |
| 所在地区 | 可留空或按项目背景填写 |
...
| :--- | :--- | :--- | :--- |
| thc1006/ntn-operators | ntn-operators.md | Apache-2.0 | ✅ 可镜像 |
...
- 无 LICENSE 只收链接不镜像
- 个人 owner 单仓库，建组织时组织描述中注明为个人作者的社区镜像
