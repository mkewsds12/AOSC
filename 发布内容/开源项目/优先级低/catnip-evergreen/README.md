# catnip-evergreen · GitLink 社区镜像组织

> 来源：<https://github.com/catnip-evergreen>
...
| 表单项 | 填写内容 |
| :--- | :--- |
| 组织账号 | `catnip-evergreen`（被占用则 `catnip-evergreen-mirror`） |
| 组织名称 | `catnip-evergreen（社区镜像）` |
| 组织描述 | 非官方社区镜像，仅收录 catnip-evergreen 公开发布的开源项目；版权归原作者（<https://github.com/catnip-evergreen>）；仓库以只读镜像方式同步，每 8 小时更新一次 |
| 所在地区 | 可留空或按项目背景填写 |
...
| :--- | :--- | :--- | :--- |
| bdot-algo | bdot-algo.md | MIT | ✅ 可镜像 |
