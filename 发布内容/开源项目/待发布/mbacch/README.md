# mbacch · GitLink 社区镜像组织

> 来源：https://github.com/mbacch
...
| 表单项 | 填写内容 |
|--------|---------|
| 组织账号 | `mbacch`（被占用则 `mbacch-mirror`） |
| 组织名称 | `mbacch（社区镜像）` |
| 组织描述 | 非官方社区镜像，仅收录 mbacch 公开发布的开源项目；版权归原作者（https://github.com/mbacch）；仓库以只读镜像方式同步，每 8 小时更新一次 |
| 所在地区 | 可留空或按项目背景填写 |
...
|-----------|---------|--------|-----------|
| awesome-cfs | awesome-cfs.md | CC0-1.0 | ✅ 可镜像 |
...
- 无 LICENSE 只收链接不镜像
- 单仓库个人 owner；注意 awesome-cfs 是 NASA cFS 的第三方资源列表，与 nasa/cfs-apps 等官方组织互为补充，不要混淆为官方来源
