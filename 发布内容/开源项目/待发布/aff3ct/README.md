# aff3ct · GitLink 社区镜像组织

> 来源：https://github.com/aff3ct
...
| 表单项 | 填写内容 |
|--------|---------|
| 组织账号 | `aff3ct`（被占用则 `aff3ct-mirror`） |
| 组织名称 | `aff3ct（社区镜像）` |
| 组织描述 | 非官方社区镜像，仅收录 aff3ct 公开发布的开源项目；版权归原作者（https://github.com/aff3ct）；仓库以只读镜像方式同步，每 8 小时更新一次 |
| 所在地区 | 可留空或按项目背景填写 |
...
|-----------|---------|--------|-----------|
| aff3ct（FEC 仿真库） | aff3ct.md | MIT | ✅ 可镜像 |
...
- 无 LICENSE 只收链接不镜像
- aff3ct 为高性能前向纠错仿真库组织，覆盖 CCSDS Turbo/RS/LDPC 码型
