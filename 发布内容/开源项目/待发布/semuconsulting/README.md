# semuconsulting · GitLink 社区镜像组织

> 来源：<https://github.com/semuconsulting>
...
| 表单项 | 填写内容 |
| :--- | :--- |
| 组织账号 | `semuconsulting`（被占用则 `semuconsulting-mirror`） |
| 组织名称 | `semuconsulting（社区镜像）` |
| 组织描述 | 非官方社区镜像，仅收录 semuconsulting 公开发布的开源项目；版权归原作者（<https://github.com/semuconsulting>）；仓库以只读镜像方式同步，每 8 小时更新一次 |
| 所在地区 | 可留空或按项目背景填写 |
...
| :--- | :--- | :--- | :--- |
| PyGPSClient | pygpsclient.md | BSD-3-Clause | ✅ 可镜像 |
