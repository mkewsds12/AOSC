# barbeau · GitLink 社区镜像组织

> 来源：https://github.com/barbeau
...
| 表单项 | 填写内容 |
|--------|---------|
| 组织账号 | `barbeau`（被占用则 `barbeau-mirror`） |
| 组织名称 | `barbeau（社区镜像）` |
| 组织描述 | 非官方社区镜像，仅收录 barbeau 公开发布的开源项目；版权归原作者（https://github.com/barbeau）；仓库以只读镜像方式同步，每 8 小时更新一次 |
| 所在地区 | 可留空或按项目背景填写 |
...
|-----------|---------|--------|-----------|
| awesome-gnss | awesome-gnss.md | Apache-2.0 | ✅ 可镜像 |
...
- 无 LICENSE 只收链接不镜像
- 单仓库个人 owner，Apache-2.0 许可宽松，镜像时保留 LICENSE 与 NOTICE（如有）
