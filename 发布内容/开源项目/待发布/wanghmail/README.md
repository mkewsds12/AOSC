# wanghmail · GitLink 社区镜像组织

> 来源：https://gitee.com/wanghmail
...
| 表单项 | 填写内容 |
|--------|---------|
| 组织账号 | `wanghmail`（被占用则 `wanghmail-mirror`） |
| 组织名称 | `wanghmail（社区镜像）` |
| 组织描述 | 非官方社区镜像，仅收录 wanghmail 公开发布的开源项目；版权归原作者（https://gitee.com/wanghmail）；仓库以只读镜像方式同步，每 8 小时更新一次 |
| 所在地区 | 可留空或按项目背景填写 |
...
|-----------|---------|--------|-----------|
| AstroLib | astrolib.md | Apache-2.0 | ✅ 可镜像 |
...
- 无 LICENSE 只收链接不镜像
- 来源平台为 Gitee（国内已有仓库），优先考虑联系作者授权或以其 Gitee 仓库为基础引入，避免重复镜像
