...
| 表单项 | 填写内容 |
| :--- | :--- |
| 组织账号 | `cnes`（被占用则 `cnes-mirror`） |
| 组织名称 | `CNES（社区镜像）` |
| 组织描述 | 非官方社区镜像，仅收录 CNES 公开发布的开源项目；版权归原作者（<https://github.com/CNES>）；仓库以只读镜像方式同步，每 8 小时更新一次 |
| 所在地区 | 可留空或按项目背景填写 |
...
| :--- | :--- | :--- | :--- |
| opensand（OpenSand 卫星仿真平台） | opensand.md | 无 LICENSE | ⚠️ 无 LICENSE 只收链接 |
...
- 无 LICENSE 只收链接不镜像
- CNES 为法国国家空间研究中心官方组织；opensand 仓库未检测到 LICENSE，专区只收录官方链接，不冒充官方
