# SatDump · GitLink 社区镜像组织

> 来源：https://github.com/SatDump
> 定位：在 GitLink 建立 SatDump 的国内社区镜像组织/账号，镜像其开源仓库
> 状态：待执行
...
| 表单项 | 填写内容 |
|--------|---------|
| 组织账号 | `satdump`（被占用则 `satdump-mirror`） |
| 组织名称 | `SatDump（社区镜像）` |
| 组织描述 | 非官方社区镜像，仅收录 SatDump 公开发布的开源项目；版权归原作者（https://github.com/SatDump）；仓库以只读镜像方式同步，每 8 小时更新一次 |
| 所在地区 | 可留空 |
...
|-----------|---------|--------|-----------|
| SatDump | [satdump.md](satdump.md) | GPL-3.0 | ✅ 可镜像 |
