# debanjan06 · GitLink 社区镜像组织

> 来源：<https://github.com/debanjan06>
...
| 表单项 | 填写内容 |
| :--- | :--- |
| 组织账号 | `debanjan06`（被占用则 `debanjan06-mirror`） |
| 组织名称 | `debanjan06（社区镜像）` |
| 组织描述 | 非官方社区镜像，仅收录 debanjan06 公开发布的开源项目；版权归原作者（<https://github.com/debanjan06>）；仓库以只读镜像方式同步，每 8 小时更新一次 |
| 所在地区 | 可留空或按项目背景填写 |
...
| :--- | :--- | :--- | :--- |
| SatelliteRL | [satelliterl.md](satelliterl.md) | MIT | ✅ 可镜像 |
...
- 无 LICENSE 只收链接不镜像
- 个人 owner，仅收录其航天相关公开仓库（强化学习卫星星座调度）
