...
> 来源：<https://sourceforge.net/projects/gmat>
...
| 表单项 | 填写内容 |
| :--- | :--- |
| 组织账号 | `gmat`（被占用则 `gmat-mirror`） |
| 组织名称 | `gmat（社区镜像）` |
| 组织描述 | 非官方社区镜像，仅收录 gmat 公开发布的开源项目；版权归原作者（<https://sourceforge.net/projects/gmat>）；仓库以只读镜像方式同步，每 8 小时更新一次 |
| 所在地区 | 可留空或按项目背景填写 |
...
- 无 LICENSE 只收链接不镜像
- 源平台为 SourceForge，许可证未能自动核查，需人工核查后再决定镜像；头像需手动从来源页获取
