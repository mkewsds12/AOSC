# ut-astria · GitLink 社区镜像组织

> 来源：https://github.com/ut-astria
...
| 表单项 | 填写内容 |
|--------|---------|
| 组织账号 | `ut-astria`（被占用则 `ut-astria-mirror`） |
| 组织名称 | `ut-astria（社区镜像）` |
| 组织描述 | 非官方社区镜像，仅收录 ut-astria 公开发布的开源项目；版权归原作者（https://github.com/ut-astria）；仓库以只读镜像方式同步，每 8 小时更新一次 |
| 所在地区 | 可留空或按项目背景填写 |
...
|-----------|---------|--------|-----------|
| AstriaGraph | astriagraph.md | GPL-3.0 | ✅ 可镜像 |
| orbdetpy | orbdetpy.md | GPL-3.0 | ✅ 可镜像 |
...
- 无 LICENSE 只收链接不镜像
- 两个仓库均为 GPL-3.0，衍生/分发需开源同等授权；镜像只读展示合规
