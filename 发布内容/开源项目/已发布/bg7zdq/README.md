# BG7ZDQ · GitLink 社区镜像组织

> 来源：<https://github.com/BG7ZDQ>
...
| 表单项 | 填写内容 |
| :--- | :--- |
| 组织账号 | `bg7zdq`（被占用则 `bg7zdq-mirror`） |
| 组织名称 | `BG7ZDQ（社区镜像）` |
| 组织描述 | 非官方社区镜像，仅收录 BG7ZDQ 公开发布的开源项目；版权归原作者（<https://github.com/BG7ZDQ>）；仓库以只读镜像方式同步，每 8 小时更新一次 |
| 所在地区 | 可留空或按项目背景填写 |
...
| :--- | :--- | :--- | :--- |
| ASRTU-1-Data-Link | asrtu-1-data-link.md | 无 LICENSE | ⚠️ 无 LICENSE 只收链接 |
...
- 无 LICENSE 只收链接不镜像
- ASRTU-1-Data-Link 未检测到 LICENSE 文件，**不可镜像代码**，专区只收录官方链接；如确需镜像，先联系项目维护者获得许可
