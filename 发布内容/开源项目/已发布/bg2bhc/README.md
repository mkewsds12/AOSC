# bg2bhc · GitLink 社区镜像组织

> 来源：<https://github.com/bg2bhc>
...
| 表单项 | 填写内容 |
| :--- | :--- |
| 组织账号 | `bg2bhc`（被占用则 `bg2bhc-mirror`） |
| 组织名称 | `bg2bhc（社区镜像）` |
| 组织描述 | 非官方社区镜像，仅收录 bg2bhc 公开发布的开源项目；版权归原作者（<https://github.com/bg2bhc>）；仓库以只读镜像方式同步，每 8 小时更新一次 |
| 所在地区 | 可留空或按项目背景填写 |
...
| :--- | :--- | :--- | :--- |
| gr-lilacsat（紫丁香卫星 GNU Radio 模块） | gr-lilacsat.md | 无 LICENSE | ⚠️ 无 LICENSE 只收链接 |
...
- 无 LICENSE 只收链接不镜像
- 哈工大紫丁香微纳卫星团队 BG2BHC 个人账号，未检测到 LICENSE，专区只收录官方链接
